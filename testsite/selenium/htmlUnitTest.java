...
// Import logging modules to turn off warnings
...
public class htmlUnitTest {
	...
	public static void main(String[] args) {
		...
		// Disable compiler warnings relating to main.css
		...
		String text = driver.findElement(By.className("post-link")).getText();
		Assert.assertNotEquals(text, "Welcome to Jekyll.");
		System.out.println("Post-link text is: " + text);
